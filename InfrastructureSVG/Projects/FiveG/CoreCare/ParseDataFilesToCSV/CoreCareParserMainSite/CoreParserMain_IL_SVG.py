...
SITE = 'IL SVG'
LISTENER_PATH = '\\\\192.168.127.247\\Cores\\SVG'
PATH_TO_SAVE = f'{Path.cwd().parent.__str__()}\\SummaryFiles\\SVG'
SETUP_NAME_LIST_PATH = '\\\\192.168.127.247\\Cores\\SVG\\MoreInformation\\setup_names.csv'
NETWORK_ADDRESS = [
